...
<%--                    <div style="font-size: 0.85em;">by <%= quiz.getAuthor() %></div>--%>
<%--                    <div style="font-size: 0.85em;">--%>
<%--                        <%--%>
<%--                            java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm");--%>
<%--                            String fullTime = sdf.format(quiz.getCreationDate());--%>
<%--                        %>--%>
<%--                        Created at <%= fullTime %>--%>
<%--                    </div>--%>
<%--                </div>--%>
...
<%--                </a>--%>
<%--                <div class="quiz-meta-box">--%>
<%--                    <span style="font-size: 0.85em;">Played <%= quiz.getPlayCount() %> times</span>--%>
<%--                </div>--%>
