...
//        }
//
//        this.friendsDAOfriendsDAO = new FriendsDAO(dbConnector)
//    }
//
//    @Before
//    public void setUp() throws SQLException {
//        friendRequestDAO = new FriendRequestDAO(dbConnector);
//    }
//
//    @Test
//    public void testCreateFriendRequest()  {
//        friendRequestDAO.createRequest("Alice", "Bob");
//        friendRequestDAO.createRequest("Charlie", "Bob");
//
//        List<String> requests = friendRequestDAO.getRequestList("Bob");
//
...
//        friendRequestDAO.createRequest("Alice", "Bob");
//        friendRequestDAO.createRequest("Charlie", "Bob");
//        friendRequestDAO.deleteRequest("Alice", "Bob");
//        List<String> requests = friendRequestDAO.getRequestList("Bob");
//
//        assertEquals(1, requests.size());
//        assertFalse(requests.contains("Alice"));
//        assertTrue(requests.contains("Charlie"));
//
//    }
//
